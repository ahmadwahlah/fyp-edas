...
const DropdownMultiSelectDialog = ({ open, onClose, onSave, editingField }) => {
  ...
  return (
    <Dialog open={Boolean(open)} onClose={handleClose}>
      <DialogTitle>Add Dropdown Multi-Select</DialogTitle>
      <DialogContent>
        <TextField
          autoFocus
          margin="dense"
...
export default DropdownMultiSelectDialog;
