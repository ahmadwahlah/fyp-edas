...
import SubmittedFormsDialog from "./SubmittedFormsDialog";
import SubmittedFormsDialogFaculty from "./SubmittedFormsDialogFaculty";
    ...
    const fetchForms = async () => {
      try {
        ...
        const apiFacultyForms =
          "http://ec2-65-0-133-29.ap-south-1.compute.amazonaws.com:8000/api/forms/faculty/all";
        const apiStudentForms =
          "http://ec2-65-0-133-29.ap-south-1.compute.amazonaws.com:8000/api/forms/student/all";
